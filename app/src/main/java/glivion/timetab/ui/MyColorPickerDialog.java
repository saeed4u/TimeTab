...
@SuppressLint("ClickableViewAccessibility") public class MyColorPickerDialog {

		public interface OnMyCustomDialogListener {
			void onCancel(MyColorPickerDialog dialog);

			void onOk(MyColorPickerDialog dialog, int color);
		}

		final AlertDialog dialog;
		final OnMyCustomDialogListener listener;
		final View viewHue;
		 ...
		 */
		@SuppressLint("InflateParams") public MyColorPickerDialog(final Context context, int color,
				OnMyCustomDialogListener listener) {
			...
			viewSatVal = (ColorPickerView) view
				...
				public boolean onTouch(View v, MotionEvent event) {
					if (event.getAction() == MotionEvent.ACTION_MOVE
						...
						if (y > viewHue.getMeasuredHeight())
							y = viewHue.getMeasuredHeight() - 0.001f; // to
																		// avoid
																		// looping
																		// from
																		// end
																		// to
																		// start.
						float hue = 360.f - 360.f / viewHue.getMeasuredHeight()
								* y;
						if (hue == 360.f)
							hue = 0.f;
						setHue(hue);
					...
					.setPositiveButton(android.R.string.ok,
							new DialogInterface.OnClickListener() {
								...
								public void onClick(DialogInterface dialog,
										int which) {
									if (MyColorPickerDialog.this.listener != null) {
										MyColorPickerDialog.this.listener.onOk(
												MyColorPickerDialog.this,
												getColor());
									}
								}
							})
					.setNegativeButton(android.R.string.cancel,
							new DialogInterface.OnClickListener() {
								...
								public void onClick(DialogInterface dialog,
										int which) {
									if (MyColorPickerDialog.this.listener != null) {
										MyColorPickerDialog.this.listener
												.onCancel(MyColorPickerDialog.this);
									}
								}
